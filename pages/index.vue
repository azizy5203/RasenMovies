    ...
    <section class="hero">
      ...
      <div class="content d-flex flex-column gap-5">
        <div class="header container d-flex justify-content-between p-4">
          <h4 class="logo animate__animated animate__fadeInDown">
            <span>Rasen</span>Movies
          </h4>
          <div class="d-flex gap-4">
            <nuxt-link
              to="/"
              class="d-none d-md-inline-block fs-6 mt-2 link-light fw-bold text-decoration-none animate__animated animate__slideInDown"
              >login</nuxt-link
            >
            <button
        ...
        <section class="typo text-center animate__animated animate__fadeInUp">
